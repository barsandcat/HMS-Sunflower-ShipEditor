...
void UVMDevices::UpdateDeviceStatus(const FText& name, const FIntVector2& device_pos, float usage, const FDeviceSector& sector, const FDeviceSector& available_sector)
{
